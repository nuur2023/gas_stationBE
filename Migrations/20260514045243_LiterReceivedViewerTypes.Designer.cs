...
namespace gas_station.Migrations
{
    ...
    [Migration("20260514045243_LiterReceivedViewerTypes")]
    partial class LiterReceivedViewerTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gas_station.Models.LiterReceived", b =>
                {
                    ...
                    b.Property<int?>("ViewerTypeId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ViewerTypeId");

                    b.ToTable("LiterReceiveds");
                });

            modelBuilder.Entity("gas_station.Models.LiterReceivedViewerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LiterReceivedViewerTypes");
                });
            ...
            modelBuilder.Entity("gas_station.Models.SupplierPayment", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "SupplierId", "Date");
            ...
            modelBuilder.Entity("gas_station.Models.LiterReceived", b =>
                {
                    b.HasOne("gas_station.Models.LiterReceivedViewerType", "ViewerType")
                        .WithMany()
                        .HasForeignKey("ViewerTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ViewerType");
                });
            ...
            modelBuilder.Entity("gas_station.Models.SupplierPayment", b =>
                {
                    ...
                    b.HasOne("gas_station.Models.Purchase", null)
                        .WithMany()
